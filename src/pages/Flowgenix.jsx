      ...
      <section className="section-padding bg-surface">
        <div className="container-custom">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-xl text-secondary-600 max-w-3xl mx-auto">
              Join hundreds of businesses already transforming their document workflows
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center animate-slide-up">
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
              Start automating your document processing today with Flowgenix's powerful AI-driven platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://flowgenix.velioniq.com"
              ...
              >
                <span>Launch Flowgenix</span>
                <ArrowRight className="w-5 h-5" />
              </a>
              <button className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-semibold px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2">
