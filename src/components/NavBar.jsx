                      ...
                      {isHome && (
                        ...
                        >
                          <ScrollLink
                            ...
                            offset={-80}
                            duration={500}
                            className="block p-3 rounded-xl hover:bg-accent-50 transition-colors duration-200 cursor-pointer text-accent-600 font-semibold relative overflow-hidden group"
